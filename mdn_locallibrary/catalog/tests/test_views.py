...
#             )
    ...
    # def test_lists_all_authors(self):
        ...
        # self.assertTrue('is_paginated' in response.context)
        # self.assertTrue(response.context['is_paginated'] == True)
        # print("len(response.context['author_list']) >>", len(response.context['author_list']))
...
#     def setUp(self):
#         # Create two users
#         test_user1 = User.objects.create_user(username='test1', password='1X<ISRUkw+tuK')
#         test_user2 = User.objects.create_user(username='test2', password='2HJ1vRV0Z&3iD')
#
#         test_user1.save()
#         test_user2.save()
#
#         # Create a book
#         test_author = Author.objects.create(first_name='리', last_name='존')
#         test_genre = Genre.objects.create(name='경제')
#         test_language = Language.objects.create(name='한국어')
...
#         login = self.client.login(username='test1', password='1X<ISRUkw+tuK')
#         response = self.client.get(reverse('my-borrowed'))
#
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def setUp(self):
        ...
        self.test_bookinstance1 = BookInstance.objects.create(book=test_book,
                                                              imprint='김상건', due_back=return_date,
                                                              borrower=test_user1, status='o')

        # Create a BookInstance object for test_user2
        return_date = datetime.date.today() + datetime.timedelta(days=5)
        self.test_bookinstance2 = BookInstance.objects.create(book=test_book, imprint='김상건',
